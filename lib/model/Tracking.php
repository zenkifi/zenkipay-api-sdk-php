...
class Tracking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'zenki_tracking_id' => 'string',
        'courier_type' => 'string',
        'tracking_id' => 'string',
        'courier_name' => 'string',
        'external_courier' => '\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\TrackingExternalCourier'
    ];
    ...
    protected static array $openAPINullables = [
        'zenki_tracking_id' => false,
		'courier_type' => false,
		'tracking_id' => true,
		'courier_name' => true,
		'external_courier' => false
    ];
    ...
    protected static $attributeMap = [
        'zenki_tracking_id' => 'zenkiTrackingId',
        'courier_type' => 'courierType',
        'tracking_id' => 'trackingId',
        'courier_name' => 'courierName',
        'external_courier' => 'externalCourier'
    ];
    ...
    protected static $setters = [
        'zenki_tracking_id' => 'setZenkiTrackingId',
        'courier_type' => 'setCourierType',
        'tracking_id' => 'setTrackingId',
        'courier_name' => 'setCourierName',
        'external_courier' => 'setExternalCourier'
    ];
    ...
    protected static $getters = [
        'zenki_tracking_id' => 'getZenkiTrackingId',
        'courier_type' => 'getCourierType',
        'tracking_id' => 'getTrackingId',
        'courier_name' => 'getCourierName',
        'external_courier' => 'getExternalCourier'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['zenki_tracking_id'] === null) {
            $invalidProperties[] = "'zenki_tracking_id' can't be null";
        }
        if ((mb_strlen($this->container['zenki_tracking_id']) > 128)) {
            $invalidProperties[] = "invalid value for 'zenki_tracking_id', the character length must be smaller than or equal to 128.";
        }
    ...
    /**
     * Gets zenki_tracking_id
     *
     * @return string
     */
    public function getZenkiTrackingId()
    {
        return $this->container['zenki_tracking_id'];
    }

    /**
     * Sets zenki_tracking_id
     *
     * @param string $zenki_tracking_id Unique tracking identifier generated by Zenkipay.
     *
     * @return self
     */
    public function setZenkiTrackingId($zenki_tracking_id)
    {
        if ((mb_strlen($zenki_tracking_id) > 128)) {
            throw new \InvalidArgumentException('invalid length for $zenki_tracking_id when calling Tracking., must be smaller than or equal to 128.');
        }


        if (is_null($zenki_tracking_id)) {
            throw new \InvalidArgumentException('non-nullable zenki_tracking_id cannot be null');
        }

        $this->container['zenki_tracking_id'] = $zenki_tracking_id;
    ...
    public function setTrackingId($tracking_id)
    {
        if (!is_null($tracking_id) && (mb_strlen($tracking_id) > 128)) {
            throw new \InvalidArgumentException('invalid length for $tracking_id when calling Tracking., must be smaller than or equal to 128.');
        }
     ...
     * Sets courier_name
     *
     * @param string|null $courier_name Internal courier name of the merchant used to deliver the service or product.
     *
     * @return self
     */
    public function setCourierName($courier_name)
    {
        if (!is_null($courier_name) && (mb_strlen($courier_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $courier_name when calling Tracking., must be smaller than or equal to 128.');
        }
    ...
    /**
     * Gets external_courier
     *
     * @return \fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\TrackingExternalCourier|null
     */
    public function getExternalCourier()
    {
        return $this->container['external_courier'];
    }

    /**
     * Sets external_courier
     *
     * @param \fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\TrackingExternalCourier|null $external_courier external_courier
     *
     * @return self
     */
    public function setExternalCourier($external_courier)
    {

        if (is_null($external_courier)) {
            throw new \InvalidArgumentException('non-nullable external_courier cannot be null');
        }

        $this->container['external_courier'] = $external_courier;
