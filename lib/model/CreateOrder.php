    ...
    */
    ...
    public function setVersion($version)
    {
        if ((mb_strlen($version) > 9)) {
            throw new \InvalidArgumentException('invalid length for $version when calling CreateOrder., must be smaller than or equal to 9.');
        }
     ...
     * Sets order_id
     *
     * @param string|null $order_id Unique order identifier generated by the merchant. In order to have correct traceability and adequate conversion metrics, it is required to send the OrderId field or the CardId Field.
     *
     * @return self
     */
    public function setOrderId($order_id)
    {
        if (!is_null($order_id) && (mb_strlen($order_id) > 128)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling CreateOrder., must be smaller than or equal to 128.');
        }
     ...
     * Sets cart_id
     *
     * @param string|null $cart_id Unique identifier of the shopping cart that allows identifying the purchase of one or more products or services. In order to have correct traceability and adequate conversion metrics, it is required to send the OrderId field or the CardId Field.
     *
     * @return self
     */
    public function setCartId($cart_id)
    {
        if (!is_null($cart_id) && (mb_strlen($cart_id) > 128)) {
            throw new \InvalidArgumentException('invalid length for $cart_id when calling CreateOrder., must be smaller than or equal to 128.');
        }
    ...
    public function setCountryCodeIso2($country_code_iso2)
    {
        if ((mb_strlen($country_code_iso2) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code_iso2 when calling CreateOrder., must be smaller than or equal to 2.');
        }
