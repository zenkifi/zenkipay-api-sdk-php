 ...
 */
class TokenOAuth2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TokenOAuth2';
    ...
    */
     ...
     * Sets access_token
     *
     * @param string $access_token The access token that will be required to send in all requests to the Zenki API.
     *
     * @return self
     */
     ...
     * Sets token_type
     *
     * @param string $token_type The access token that will be required to send as a header in all requests to the Zenki API.
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int $expires_in Access token expiration time in seconds.
     *
     * @return self
     */
