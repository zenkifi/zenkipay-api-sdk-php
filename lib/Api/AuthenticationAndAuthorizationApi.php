...
/**
     ...
     * @param  \Zenkipay\Model\RequestTokenOAuth2 $request_token_o_auth2 Parameters for OAuth 2 token creation. (optional)
     ...
     * @return \Zenkipay\Model\TokenOAuth2|\Zenkipay\Model\AuthenticationErrorResponse|\Zenkipay\Model\AuthenticationErrorResponse
     */
     ...
     * @throws \Zenkipay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Zenkipay\Model\TokenOAuth2|\Zenkipay\Model\AuthenticationErrorResponse|\Zenkipay\Model\AuthenticationErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTokenWithHttpInfo($content_type, $accept, $request_token_o_auth2 = null, string $contentType = self::contentTypes['createToken'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zenkipay\Model\TokenOAuth2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Zenkipay\Model\TokenOAuth2' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Zenkipay\Model\TokenOAuth2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Zenkipay\Model\AuthenticationErrorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Zenkipay\Model\AuthenticationErrorResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Zenkipay\Model\AuthenticationErrorResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            $returnType = '\Zenkipay\Model\TokenOAuth2';
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Zenkipay\Model\AuthenticationErrorResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createTokenRequest($content_type, $accept, $request_token_o_auth2 = null, string $contentType = self::contentTypes['createToken'][0])
    {
        ...
        if (isset($request_token_o_auth2)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($request_token_o_auth2));
            } else {
