...
/**
     ...
     * @param  \fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\AddTrackingEvent $add_tracking_event A JSON structure will be sent that will have the required information to update the shipping status. (optional)
     ...
     * @return \fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\TrackingEventsInner[]|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse
     */
     ...
     * @throws \fi.zenki.zenkipay.api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\TrackingEventsInner[]|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function addEventTrackingWithHttpInfo($zenki_order_id, $zenki_track_id, $content_type, $accept, $x_zenki_plugin_id = null, $accept_language = null, $add_tracking_event = null, string $contentType = self::contentTypes['addEventTracking'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\TrackingEventsInner[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\TrackingEventsInner[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\TrackingEventsInner[]', []),
            ...
            $returnType = '\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\TrackingEventsInner[]';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\TrackingEventsInner[]',
    ...
    public function addEventTrackingRequest($zenki_order_id, $zenki_track_id, $content_type, $accept, $x_zenki_plugin_id = null, $accept_language = null, $add_tracking_event = null, string $contentType = self::contentTypes['addEventTracking'][0])
    {
        ...
        if (isset($add_tracking_event)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($add_tracking_event));
            } else {
     ...
     * @param  string $x_zenki_plugin_id Unique customer identifier used to establish connection with Zenkipay services. (optional)
     * @param  string $accept_language Indicates the language type code for which the content of the services response is returned according to the language reported.  The definition of the ISO_639 standard is used. See: https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes or https://www.iso.org/iso-639-language-codes.html (optional)
     * @param  \fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\AddTracking $add_tracking The registration of a tracking number associated with a shipment may be requested so that Zenkipay can track the delivery process, as reported by the courier. (optional)
     ...
     * @throws \fi.zenki.zenkipay.api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Tracking|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse
     */
     ...
     * @throws \fi.zenki.zenkipay.api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Tracking|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function registerTrackingOrdersWithHttpInfo($zenki_order_id, $content_type, $accept, $x_zenki_plugin_id = null, $accept_language = null, $add_tracking = null, string $contentType = self::contentTypes['registerTrackingOrders'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Tracking' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Tracking' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Tracking', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Tracking';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Tracking',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function registerTrackingOrdersRequest($zenki_order_id, $content_type, $accept, $x_zenki_plugin_id = null, $accept_language = null, $add_tracking = null, string $contentType = self::contentTypes['registerTrackingOrders'][0])
    {
        ...
        if (isset($add_tracking)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($add_tracking));
            } else {
