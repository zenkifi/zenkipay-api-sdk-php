...
/**
     ...
     * @return \fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Merchant|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse
     */
     ...
     * @throws \fi.zenki.zenkipay.api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Merchant|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse|\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMerchantInfoWithHttpInfo($content_type, $accept, $x_zenki_plugin_id = null, $accept_language = null, string $contentType = self::contentTypes['getMerchantInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Merchant' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Merchant' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Merchant', []),
            ...
            $returnType = '\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Merchant';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fi.zenki.zenkipay.api\fi.zenki.zenkipay.api.model\Merchant',
